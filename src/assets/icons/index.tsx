...
export const ModifyIcon: React.FC<SVGProps<SVGSVGElement>> = (props) => {
    return (
...
export const RemoveIcon: React.FC<SVGProps<SVGSVGElement>> = (props) => {
    return (
        <svg viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg"
             fill="#000000" stroke="#000000" {...props}>
            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
            <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"/>
            <g id="SVGRepo_iconCarrier"><title>cancel</title>
                <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <g id="work-case" fill="#e15b5b" transform="translate(91.520000, 91.520000)">
                        <polygon id="Close"
...
export const SuccessIcon: React.FC<SVGProps<SVGSVGElement>> = (props) => {
    return (
        <svg fill="#2baa22" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#2baa22" {...props}>
            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
            <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
            <g id="SVGRepo_iconCarrier">
